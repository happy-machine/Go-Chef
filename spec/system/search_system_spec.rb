...
RSpec.describe "Search_system", :type => :system do
  ...
  it "will let me log in and update my settings", js: true do
    ...
    fill_in 'Email', with: 'gordon@gmail.com'  
