...
RSpec.describe UsersController, type: :controller do
  ...
  let(:valid_attributes) {
    {postcode: 'ox331pu', email: 'ains@aol.com',max_party_size: 20, is_a_chef:true, is_chef?: true, price_per_head: 800, location_lat: 51.8745476,location_lon: -1.5338750, bio: 'Presenter for many BBC cooking shows.\n Ainsley Harriott (born 28 February 1957) is an English chef, television presenter, and entertainer. He is known for his BBC cooking shows Cant Cook, Wont Cook and Ready Steady Cook. '}
  }
